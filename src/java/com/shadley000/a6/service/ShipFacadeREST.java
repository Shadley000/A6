 ...
 */
package com.shadley000.a6.service;
...
@Stateless
@Path("ship")
public class ShipFacadeREST extends AbstractFacade<Ship> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Ship entity) {
        super.edit(entity);
    }
    ...
    public Ship find(@PathParam("id") Integer id) {
